...
class B:
    ...
    @Predicate
    def state(self) -> bool:
        return Bcc(self.i) and Bcc(self.s) and Bcc(self.b)
...
class C:
    ...
    @Predicate
    def state(self) -> bool:
        return Ccc(self.i) and Ccc(self.s) and Ccc(self.b)
...
class D:
    ...
    @Predicate
    def state(self) -> bool:
        return Dcc(self.i) and Dcc(self.s) and Dcc(self.b)
...
class E:
    ...
    @Predicate
    def state(self) -> bool:
        return Ecc(self.i) and Ecc(self.s) and Ecc(self.b)
...
class F:
    ...
    @Predicate
    def state(self) -> bool:
        return Fcc(self.i) and Fcc(self.s) and Fcc(self.b)
...
class G:
    ...
    @Predicate
    def state(self) -> bool:
        return Gcc(self.i) and Gcc(self.s) and Gcc(self.b)
...
class H:
    ...
    @Predicate
    def state(self) -> bool:
        return Hcc(self.i) and Hcc(self.s) and Hcc(self.b)
