...
Install Java 8 or newer (64 bit) and Python 3.5 or newer (64 bit) and the required libraries::
...
1.  Install Java 8 or newer (64 bit) and Python 3.5 or newer (64 bit).
