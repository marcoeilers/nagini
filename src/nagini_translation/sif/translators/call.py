...
from nagini_translation.lib.program_nodes import PythonClass, PythonType
...
from nagini_translation.sif.lib.program_nodes import SIFPythonMethod
...
class SIFCallTranslator(CallTranslator, ExprCacheMixin):
    ...
    def translate_Call(self, node: ast.Call, ctx: SIFContext,
        ...
        return super().translate_Call(node, ctx, impure, statement)
