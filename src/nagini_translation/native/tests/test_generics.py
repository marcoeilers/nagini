...
fixpoint PyClass PyClass_module_0MyException(){
        return PyClass("module_0MyException", Exception, nil);
}
"""
...
def test_forallAcc1(l: List[Someclass[float, int, float]]) -> int:
        ...
        forall_predfact(?l__content_DOT_t, pyobj_hasPyClassInstanceval(PyClass_module_0MyException(PyFloat_t, PyLong_t, PyFloat_t)), True, nil) &*&
        ...
        forall_predfact(?NEW_l__content, pyobj_hasPyClassInstanceval(PyClass_module_0MyException(PyFloat_t, PyLong_t, PyFloat_t)), True, nil) &*&
