...
def simpletuple_eq(t: Tuple[int, int]) -> int:
        """
static PyObject * simpletuple_eq(PyObject *self, PyObject *args)
...
def simpletuple_neq1(t: Tuple[int, int]) -> int:
        """
static PyObject * simpletuple_neq1(PyObject *self, PyObject *args)
requires PyExc(none, none) &*&
gil_lock(?gstate) &*&
hasRef(args, false) &*&
pyobj_hasval(args, PyTuple_v(cons(pair(?t__ptr, PyTuple_t(cons(PyLong_t, cons(PyLong_t, nil)))), nil))) &*&
...
def simpletuple_neq2(t: Tuple[int, int]) -> int:
        """
static PyObject * simpletuple_neq2(PyObject *self, PyObject *args)
requires PyExc(none, none) &*&
gil_lock(?gstate) &*&
hasRef(args, false) &*&
pyobj_hasval(args, PyTuple_v(cons(pair(?t__ptr, PyTuple_t(cons(PyLong_t, cons(PyLong_t, nil)))), nil))) &*&
...
def doubletuple_eq1(t: Tuple[Tuple[int, int], int]) -> int:
        """
static PyObject * doubletuple_eq1(PyObject *self, PyObject *args)
requires PyExc(none, none) &*&
gil_lock(?gstate) &*&
hasRef(args, false) &*&
