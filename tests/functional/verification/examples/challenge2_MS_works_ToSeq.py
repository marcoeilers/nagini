...
def merge(r1: SR, r2: SR) -> SR:
    ...
    Requires(len(ToSeq(r1.runs)) > 0 and len(ToSeq(r2.runs)) > 0 and len(ToSeq(r1.data)) > 0 and len(ToSeq(r2.data)) > 0)
    Requires(ToSeq(r1.runs)[-1] == len(ToSeq(r1.data)))
    Requires(ToSeq(r2.runs)[-1] == len(ToSeq(r2.data)))
    Requires(Forall(int, lambda i: (Implies(i >= 0 and i < len(ToSeq(r1.runs)) - 1, 0 < ToSeq(r1.runs)[i] and ToSeq(r1.runs)[i] < ToSeq(r1.runs)[i + 1]
                                            and ToSeq(r1.runs)[i] < len(ToSeq(r1.data))), [[ToSeq(r1.runs)[i]]])))
    Requires(Forall(int, lambda i: (Implies(i >= 0 and i < len(ToSeq(r2.runs)) - 1, 0 < ToSeq(r2.runs)[i] and ToSeq(r2.runs)[i] < ToSeq(r2.runs)[i + 1]
                                            and ToSeq(r2.runs)[i] < len(ToSeq(r2.data))), [[ToSeq(r2.runs)[i]]])))
    ...
    Ensures(len(ToSeq(Result().runs)) > 0 and ToSeq(Result().runs)[-1] == len(ToSeq(Result().data)))
    Ensures(Forall(int, lambda i: (Implies(i >= 0 and i < len(ToSeq(Result().runs)) - 1,
                                           0 < ToSeq(Result().runs)[i] and ToSeq(Result().runs)[i] < ToSeq(Result().runs)[i + 1] and
                                           ToSeq(Result().runs)[i] < len(ToSeq(Result().data))), [[ToSeq(Result().runs)[i]]])))
...
def outer_loop(r1: SR, r2: SR, res: SR) -> None:
    ...
    Requires(ToSeq(r2.runs)[-1] == len(ToSeq(r2.data)))
    Requires(
        Forall(int, lambda i: (Implies(i >= 0 and i < len(ToSeq(r1.runs)) - 1, 0 < ToSeq(r1.runs)[i] and ToSeq(r1.runs)[i] < ToSeq(r1.runs)[i + 1]
                                       and ToSeq(r1.runs)[i] < len(ToSeq(r1.data))), [[ToSeq(r1.runs)[i]]])))
    Requires(
        Forall(int, lambda i: (Implies(i >= 0 and i < len(ToSeq(r2.runs)) - 1, 0 < ToSeq(r2.runs)[i] and ToSeq(r2.runs)[i] < ToSeq(r2.runs)[i + 1]
                                       and ToSeq(r2.runs)[i] < len(ToSeq(r2.data))), [[ToSeq(r2.runs)[i]]])))
    ...
    Ensures(len(ToSeq(r1.runs)) > 0 and len(ToSeq(r2.runs)) > 0 and len(ToSeq(r1.data)) > 0 and len(ToSeq(r2.data)) > 0)
    Ensures(ToSeq(r1.runs)[-1] == len(ToSeq(r1.data)))
    Ensures(ToSeq(r2.runs)[-1] == len(ToSeq(r2.data)))
    Ensures(
        Forall(int, lambda i: (Implies(i >= 0 and i < len(ToSeq(r1.runs)) - 1, 0 < ToSeq(r1.runs)[i] and ToSeq(r1.runs)[i] < ToSeq(r1.runs)[i + 1]
                                       and ToSeq(r1.runs)[i] < len(ToSeq(r1.data))), [[ToSeq(r1.runs)[i]]])))
    Ensures(
    ...
    Ensures(len(ToSeq(res.runs)) > 0 and ToSeq(res.runs)[-1] == len(ToSeq(res.data)))
    Ensures(Forall(int, lambda i: (Implies(i >= 0 and i < len(ToSeq(res.runs)) - 1,
    ...
    while ri1 < len(r1.runs) or ri2 < len(r2.runs):
        ...
        Invariant(len(ToSeq(r1.runs)) > 0 and len(ToSeq(r2.runs)) > 0 and len(ToSeq(r1.data)) > 0 and len(ToSeq(r2.data)) > 0)
        ...
        Invariant(ToSeq(r1.runs)[-1] == len(ToSeq(r1.data)))
        Invariant(ToSeq(r2.runs)[-1] == len(ToSeq(r2.data)))
        Invariant(Forall(int, lambda i: (
        Implies(i >= 0 and i < len(ToSeq(r1.runs)) - 1, 0 < ToSeq(r1.runs)[i] and ToSeq(r1.runs)[i] < ToSeq(r1.runs)[i + 1]
                and ToSeq(r1.runs)[i] < len(ToSeq(r1.data))), [[ToSeq(r1.runs)[i]]])))
        Invariant(Forall(int, lambda i: (
        Implies(i >= 0 and i < len(ToSeq(r2.runs)) - 1, 0 < ToSeq(r2.runs)[i] and ToSeq(r2.runs)[i] < ToSeq(r2.runs)[i + 1]
                and ToSeq(r2.runs)[i] < len(ToSeq(r2.data))), [[ToSeq(r2.runs)[i]]])))
...
def inner_loop(r1: SR, res: SR, ri1: int, di1: int) -> int:
    ...
    Requires(ToSeq(r1.runs)[-1] == len(ToSeq(r1.data)))
    Requires(Forall(int, lambda i: (Implies(i >= 0 and i < len(ToSeq(r1.runs)) - 1,
                                             0 < ToSeq(r1.runs)[i] and ToSeq(r1.runs)[i] < ToSeq(r1.runs)[i + 1] and
                                             ToSeq(r1.runs)[i] < len(ToSeq(r1.data))), [[ToSeq(r1.runs)[i]]])))
    ...
    Ensures(ToSeq(r1.runs)[-1] == len(ToSeq(r1.data)))
    Ensures(Forall(int, lambda i: (Implies(i >= 0 and i < len(ToSeq(r1.runs)) - 1,
                                             0 < ToSeq(r1.runs)[i] and ToSeq(r1.runs)[i] < ToSeq(r1.runs)[i + 1] and
                                             ToSeq(r1.runs)[i] < len(ToSeq(r1.data))), [[ToSeq(r1.runs)[i]]])))
    ...
    while di1 < r1.runs[ri1]:
        ...
        Invariant(r1.runs[-1] == len(ToSeq(r1.data)))
        Invariant(Forall(int, lambda i: (Implies(i >= 0 and i < len(ToSeq(r1.runs)) - 1,
                                                 0 < ToSeq(r1.runs)[i] and ToSeq(r1.runs)[i] < ToSeq(r1.runs)[i + 1] and
                                                 ToSeq(r1.runs)[i] < len(ToSeq(r1.data))), [[ToSeq(r1.runs)[i]]])))
...
def msort(a: List[int], l: int, h: int) -> SR:
    ...
    Ensures(Acc(Result().runs) and Acc(Result().data) and list_pred(Result().runs) and list_pred(Result().data))
    Ensures(Implies(h > l, len(ToSeq(Result().runs)) > 0))
    Ensures(len(ToSeq(Result().data)) == h - l)
    Ensures(Implies(h > l, ToSeq(Result().runs)[-1] == len(ToSeq(Result().data))))
    Ensures(Forall(int, lambda i: (Implies(i >= 0 and i < len(ToSeq(Result().runs)) - 1,
                                           0 < ToSeq(Result().runs)[i] and ToSeq(Result().runs)[i] < ToSeq(Result().runs)[i + 1] and
                                           ToSeq(Result().runs)[i] < len(ToSeq(Result().data))), [[ToSeq(Result().runs)[i]]])))
